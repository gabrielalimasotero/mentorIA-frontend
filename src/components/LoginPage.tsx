...
import { BookOpen, Target, TrendingUp, Mail, Lock, User, ArrowLeft } from 'lucide-react';
...
const LoginPage = ({ onLogin }: LoginPageProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (authMode === 'login' || authMode === 'register') {
      const username = authMode === 'register' ? name : email.split('@')[0];
      if (username.trim()) {
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm border border-blue-100">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Metas Gamificadas</h3>
              <p className="text-sm text-gray-600 text-center">Progresso e acompanhamento detalhado</p>
            </div>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md mx-auto shadow-xl border-blue-100">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600">
              {authMode === 'login' && 'Entre para acessar a plataforma'}
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                ...
                disabled={
                  !email.trim() || 
                  (authMode !== 'forgot' && !password.trim()) ||
                  (authMode === 'register' && (!name.trim() || password !== confirmPassword))
                }
              >
                {authMode === 'login' && 'Entrar'}
                {authMode === 'register' && 'Criar Conta'}
